...
class Element5View(ElementView):
    ...
    def __init__(self, parent=None,data_representation = None,show_remove_button=True,default_offer = Element5(1,'','','','','','','','','',0,0,0),*args, **kw):
        super(Element5View, self).__init__(parent=parent,show_remove_button=show_remove_button ,*args, **kw)
    ...
    def InitUI(self,data):
        ...
        self.data_sizer.AddMany([
            (wx.StaticText(self,label="###"),1, wx.FIXED_MINSIZE),(wx.StaticText(self,label="Element5"),1, wx.FIXED_MINSIZE),
    ...
    def GetData(self):
        ...
        for d in self.dodatki:
            if d:
                ...
                db_dodatki.append(Dodatki_Element5(
        ...
        element = Element5(self.value1.GetValue(), self.value2.GetValue(), self.value3.GetValue(), self.value3.GetValue(), self.value4.GetValue(),self.value5.GetValue(),self.value6.GetValue(),self.value7.GetValue(),self.value8.GetValue(), self.value9.GetValue(), cenaZL1, cenaZL2, cenaZL3, dodatki=db_dodatki, id=self._id)
        return element
